...
#
# This knowledge basee lab was very fun and very challenging in the sense of knowing which
# ontology to use for the story that was given. So knowing when to use vitctim(x)
# was neccessary and when to know it isn't. I would like to acknowledge 
# Achyuth Kolluru who helped understand the syntax and once I understood,
# I finished my lab.
#
# Shane Clanton Oct 27, 2022
#
